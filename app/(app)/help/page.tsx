...
const resources = [
  { icon: Zap, title: "Quick Start", description: "Build your first project in under 5 minutes.", href: "#quick-start" },
  { icon: BookOpen, title: "Documentation", description: "In-depth guides for all features.", href: "#docs" },
  { icon: Video, title: "Video Tutorials", description: "Watch step-by-step walkthroughs.", href: "#videos" },
  { icon: FileText, title: "Changelog", description: "See what's new in every release.", href: "#changelog" },
];
  ...
  return (
    <div className="flex flex-col gap-8 p-6 max-w-3xl">
      ...
      <section id="quick-start">
        <h2 className="text-lg font-bold mb-5">Quick Start</h2>
        <div className="space-y-3">
          {[
            { step: "1", title: "Create an account", body: "Sign up at webagt.ai using your email or Google account. It's free to get started." },
            { step: "2", title: "Create a new project", body: 'Click "Create Project" on your dashboard. Choose between a website or a webshop, give it a name, and describe what you want to build.' },
            { step: "3", title: "Describe your idea", body: 'In the editor, type what you want in plain language. For example: "A landing page for a coffee brand with a hero section and pricing table."' },
            { step: "4", title: "Iterate with AI", body: "The AI generates your code instantly with a live preview. Keep prompting to refine — add sections, change colors, update content." },
            { step: "5", title: "Export or share", body: "When you're happy, export your project as a standalone Vite app or share the live preview link." },
          ].map((item) => (
            <div key={item.step} className="flex gap-4 rounded-xl border border-border bg-muted/10 p-5">
      ...
      {/* Contact CTA */}
      <section className="rounded-2xl border border-border bg-muted/20 p-6 text-center">
